...
const { orderAdd, orderGet, orderSearch, adminSeenOrdersSearch, singleOrder, orderCompeleteToBlanceAdd, orderCancelToBalanceSub, orderStatusUpdate, allCompletedOrder, orderStatusUpdatedMyHistory } = require("../controllers/OrderControllers");
...
router.route("/products/orders/completed").get(protect, allCompletedOrder);
